...
function updateNavigationByRole() {
  ...
  if (isAdmin()) {
    ...
    adminItem.innerHTML = `<a class="dropdown-item" href="${getDashboardPath(
      "admin.html"
    )}">Admin Panel</a>`;
  ...
  if (isSeller()) {
    ...
    sellerItem.innerHTML = `<a class="dropdown-item" href="${getDashboardPath(
      "seller.html"
    )}">Seller Dashboard</a>`;
  ...
  if (isCustomer()) {
    ...
    customerItem.innerHTML = `<a class="dropdown-item" href="${getDashboardPath(
      "customer.html"
    )}">My Dashboard</a>`;
...
function resetNavigation() {
  ...
  dropdownMenu.innerHTML = `
        <li><a class="dropdown-item" href="${getGeneralPath(
          "login.html"
        )}">Login</a></li>
        <li><a class="dropdown-item" href="${getGeneralPath(
          "register.html"
        ...
        <li><a class="dropdown-item" href="${getDashboardPath(
          "customer.html"
        )}">My Dashboard</a></li>
        <li><a class="dropdown-item" href="${getDashboardPath(
          "seller.html"
