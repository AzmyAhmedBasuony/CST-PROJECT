...
// Update cart summary with shipping and coupon
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-end">
                                <button class="btn btn-danger btn-sm mb-2" onclick="removeFromCart(${item.id})">
                                    <i class="fas fa-trash"></i> Remove
                                </button>
                                <br>
                                <a href="product.html?id=${item.id}" class="btn btn-outline-primary btn-sm">
                                    View Details
                                </a>
                            </div>
                        </div>
